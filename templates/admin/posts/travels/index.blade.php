    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Tous les annonces voyages</h5>
                        <table class="table datatable">
                            ...
                            @foreach($travels as $travel)
                                <tr class="text-center">
                                    ...
                                    <td class="text-start"><a href="{{ $travel->ticket }}"><img src="{{ $travel->ticket }}" width="50" height="50" class="rounded avatar"  alt=""></a></td>
