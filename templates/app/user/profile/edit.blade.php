                    ...
                    <div class="form-group">
                        ...
                        <select id="country" name="country" class="form-control">
                            @foreach($countries as $country)
                                <option value="{{ $country->code }}" @if($country->code == $profile->country)selected=""@endif>{{ $country->name }}</option>
                            @endforeach
                        </select>
                        @error('country')
                            <span class="invalid-feedback" role="alert">
...
<div class="row">
        <div class="col-lg-8 my-4 border py-2">
            ...
            <div class="py-2">
                ...
                <form action="{{ route('profile.identityFiles.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <select class="form-select" name="category">
                            <option value="Carte d'identité" selected="">Carte d'identité - recto verso</option>
                            <option value="Permis de conduire">Permis de conduire - recto verso </option>
                            <option value="Passeport">Passeport</option>
                            <option value="Titre de séjour">Titre de séjour - recto verso</option>
                        </select>
                    </div>
                    <div class="form-group my-3">
                        <input class="form-control" type="file" id="formFile" name="identity">
                    </div>
                    <div class="form-group">
