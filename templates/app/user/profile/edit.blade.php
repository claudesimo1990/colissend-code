...
<form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 p-2 text-center">
            ...
            <img src="{{ !is_null(Auth::user()->getFirstMedia('avatar')) ? Auth::user()->getFirstMedia('avatar')->getUrl('thumb') : Auth::user()->avatar ?? asset('images/colissend/default.svg') }}" class="rounded-circle text-center"   alt="{{ Auth::user()->name }}">
            <div class="pt-2">
